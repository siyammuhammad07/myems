...
public class DisplayAllEmps_jFrame extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        model = new DefaultTableModel(new Object[] {"Status","Emp Num","First Name", "Last Name", "Salary", "Gender",
                                                   "Deduct Rate", "Hourly Wage", "Hours Per Week", "Weeks Per Year", "wLocation"},numInHT);
            ...
            for (int i = 0; i < mainHT.buckets.length; i++) {
                for (int j = 0; j < mainHT.buckets[i].size(); j++) {
                    ...
                    if (theEmp instanceof FTE) {
                        ...
                        model.setValueAt(theEmp.getGender(), empCounter, 5);
                        ...
                        model.setValueAt(theEmp.getWorkLoc(), empCounter, 10);
                    }
